...
namespace RMS.Utility
{
    ...
    public sealed class Settings
    {
        ...
        /// </summary>
        private Dictionary<string, object> m_settingsItemDictionary = new Dictionary<string, object>();
        ...
        public int Count
        {
            get
            {
                ...
                try
                {
                    return this.m_settingsItemDictionary.Count;
                }
                finally
                {
        ...
        public string[] Keys
        {
            get
            {
                ...
                try
                {
                    string[] result = new string[this.m_settingsItemDictionary.Count];
                    this.m_settingsItemDictionary.Keys.CopyTo(result, 0);
                    return result;
                }
                finally
                {
        ...
        public object[] Values
        {
            get
            {
                ...
                try
                {
                    object[] result = new object[this.m_settingsItemDictionary.Count];
                    this.m_settingsItemDictionary.Values.CopyTo(result, 0);
                    return result;
                }
                finally
                {
        ...
        public void SetValue(string key, object value)
        {
            ...
            try
            {
                this.m_settingsItemDictionary[key] = value;
            }
            finally
            {
                this.m_readerWriterLock.ReleaseWriterLock();
        ...
        public object GetValue(string key, bool refresh = false)
        {
            ...
            try
            {
                if (this.m_settingsItemDictionary.ContainsKey(key))
                {
                    try
                    {
                        return this.m_settingsItemDictionary[key];
                    }
                    catch (Exception e)
                    {
                        InternalLogger.Log(e);
        ...
        public T GetValue<T>(string key, bool refresh = false)
        {
            ...
            try
            {
                if (this.m_settingsItemDictionary.ContainsKey(key))
                {
                    try
                    {
                        return (T)this.m_settingsItemDictionary[key];
                    }
                    catch (Exception e)
                    {
                        InternalLogger.Log(e);
        ...
        public void Remove(string key)
        {
            ...
            try
            {
                this.m_settingsItemDictionary.Remove(key);
            }
            finally
            {
                this.m_readerWriterLock.ReleaseWriterLock();
        ...
        public bool Contains(string key)
        {
            ...
            try
            {
                return this.m_settingsItemDictionary.ContainsKey(key);
            }
            finally
            {
                this.m_readerWriterLock.ReleaseReaderLock();
