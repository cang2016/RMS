...
namespace RMS.Utility
{
    ...
    public static class Algorithms
    {
        ...
        public static IEnumerable<T> Replace<T>(IEnumerable<T> collection, T itemFind, T replaceWith, IEqualityComparer<T> equalityComparer)
        {
            ...
            equalityComparer.NotNull("equalityComparer");
        ...
        {
            list.NotNull("list");
            itemsToLookFor.NotNull("itemsToLookFor");
            equalityComparer.NotNull("equalityComparer");
        ...
        {
            collection1.NotNull("collection1");
            collection2.NotNull("collection2");
            equalityComparer.NotNull("equalityComparer");
        ...
        {
            start.NotNullOrEmptyOrSpaceWhite("collection");
            separator.NotNullOrEmptyOrSpaceWhite("separator");
            end.NotNullOrEmptyOrSpaceWhite("end");
        ...
        public static T[] RandomShuffle<T>(IEnumerable<T> collection, Random randomGenerator)
        {
            ...
            collection.NotNull("collection");
            randomGenerator.NotNull("randomGenerator");
        ...
        {
            collections.NotNull("collectioin");
            comparer.NotNull("comparer");
        ...
        {
            sourceCollection.NotNull("sourceCollection");
            converter.NotNull("converter");
        ...
        {
            collections.NotNull("collections");
