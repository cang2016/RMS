namespace DockSample
{
    ...
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
            ...
            DockPanelSkin dockPanelSkin5 = new DockPanelSkin();
           AutoHideStripSkin autoHideStripSkin5 = new AutoHideStripSkin();
            DockPanelGradient dockPanelGradient13 = new DockPanelGradient();
            TabGradient tabGradient29 = new TabGradient();
            DockPaneStripSkin dockPaneStripSkin5 = new DockPaneStripSkin();
            DockPaneStripGradient dockPaneStripGradient5 = new DockPaneStripGradient();
            TabGradient tabGradient30 = new TabGradient();
            DockPanelGradient dockPanelGradient14 = new DockPanelGradient();
            TabGradient tabGradient31 = new TabGradient();
            DockPaneStripToolWindowGradient dockPaneStripToolWindowGradient5 = new DockPaneStripToolWindowGradient();
            TabGradient tabGradient32 = new TabGradient();
            TabGradient tabGradient33 = new TabGradient();
            DockPanelGradient dockPanelGradient15 = new DockPanelGradient();
            TabGradient tabGradient34 = new TabGradient();
            TabGradient tabGradient35 = new TabGradient();
